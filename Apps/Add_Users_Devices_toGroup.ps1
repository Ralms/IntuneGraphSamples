...
################################
#Graph API have a limitation of 100 calls, with this fuction it will get all members until it stops

Function Get-AADRecursive(){
    ...
    try{
        ...
        if($membersResp.'@odata.nextLink'){
            $membersResult += Get-AADRecursive -uri $membersResp.'@odata.nextLink'
        }
